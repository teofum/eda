...
public class Metaphone {
    ...
    private static String encode(String text) {
        ...
        // Pre process string by removing all non-alphabetic characters and converting
        // to uppercase
        ...
        while (w < in.length)
            in[w++] = 0; // Fill in with zeros if we removed any characters
        ...
        var skipFirst = (c1 == 'R' && c0 == 'W') || (c1 == 'E' && c0 == 'A')
                || (c1 == 'N' && (c0 == 'G' || c0 == 'K' || c0 == 'P'));
        ...
        for (r = skipFirst ? 1 : 0, w = 0; r < in.length; r++) {
            ...
            if (c != 'C' && c1 == c)
                continue; // 1. Drop duplicates except C
            switch (c) {
                // 4. C -> X, S, K
                case 'C' -> {
                    if (c1 == 'H' || (c1 == 'I' && c2 == 'A'))
                ...
                case 'G' -> {
                    // 6. G -> nil
                    if (c1 == 'H' && !(c2 == 0 || vowel(c2)))
                        continue;
                    if (c1 == 'N' && (c2 == 0 || (in.length == r + 4 && c2 == 'E' && in[r + 3] == 'D')))
                        continue;

                    // 7. G -> J, K
                    if (b != 'G' && (c1 == 'I' || c1 == 'E' || c1 == 'Y'))
                        c = 'J';
                    else
                        c = 'K';
                }
